...
public class EntityRathalosFireball extends EntityThrowable {
	...
	public EntityRathalosFireball(World par1World, double par2, double par4, double par6, double par8, double par10, double par12)
	{
	        super(par1World, par2, par4, par6);
	}

	public EntityRathalosFireball(World par1World, EntityLivingBase par2EntityLivingBase, double par3, double par5, double par7)
	{
		...
		for (int i = 0; i < list.size(); i++) {
			...
			if(!worldObj.isRemote){
				if(var1.entityHit != null){
					this.worldObj.newExplosion((Entity)null, this.posX, this.posY, this.posZ, (float)this.radius, true, this.worldObj.getGameRules().getGameRuleBooleanValue("mobGriefing"));
