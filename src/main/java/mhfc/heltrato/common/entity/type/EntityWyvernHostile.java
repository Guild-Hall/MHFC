...
import mhfc.heltrato.common.ai.AIWyvernAttackOnCollide;
import mhfc.heltrato.common.ai.AIWyvernWander;
...
public class EntityWyvernHostile extends EntityCreature implements IMob
{
	...
	protected void updateFallState(double par1, boolean par3) {}
     ...
     public void applyMonsterAttributes(double knockback, double baselowhp, double basemedhp, double basehighhp, double baseRange , double baseSpeed){
    	speed = baseSpeed;
 		getEntityAttribute(SharedMonsterAttributes.knockbackResistance).setBaseValue(knockback);
 		getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(healthbaseHP(baselowhp, basemedhp, basehighhp));
 		getEntityAttribute(SharedMonsterAttributes.followRange).setBaseValue(baseRange);
