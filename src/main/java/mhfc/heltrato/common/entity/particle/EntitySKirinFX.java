package mhfc.heltrato.common.entity.particle;
...
{
	private static final ResourceLocation texture = new ResourceLocation("mhfc:textures/particle/kirinSFX.png");
    float field_70569_a;

    public EntitySKirinFX(World par1World, double par2, double par4, double par6, double par8, double par10, double par12)
    {
