package mhfc.heltrato.common.weapon.melee;
...
import mhfc.heltrato.common.weapon.IItemWeapon;
 ...
 */
public class WeaponMelee extends ItemSword implements IItemWeapon{

	public ComponentMelee weapon;
	...
	{
		return weapon.onBlockDestroyed(itemstack, world, block, j, k, l, entityliving);
	}
