...
public class ItemFrontierSpawner extends Item
{
    ...
    {
    	MHFCEggInfo entityegginfo = (MHFCEggInfo)MHFCMobList.entityEggs.get(Integer.valueOf(par1ItemStack.getItemDamage()));
    ...
    {
        Iterator iterator = MHFCMobList.entityEggs.values().iterator();

        while (iterator.hasNext())
        {
        	MHFCEggInfo entityegginfo = (MHFCEggInfo)iterator.next();
