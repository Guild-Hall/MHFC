...
public class WeaponHHTigrex extends SiegeClass {

	private float weaponDamage;
	// private EntityLivingBase target;

	public static final int COOLDOWN = 1300; // 200 - cooldown in ticks. 1 sec -
												// 20 ticks.
	public WeaponHHTigrex(ToolMaterial getType) {
		super(getType);
	...
	public void registerIcons(IIconRegister par1IconRegister) {
		itemIcon = par1IconRegister
				.registerIcon(MHFCReference.weapon_hh_tigrex_icon);
	}
