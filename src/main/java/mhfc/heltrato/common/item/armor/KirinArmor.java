...
public class KirinArmor extends ItemArmor  {
	...
	public KirinArmor(ArmorMaterial armor, int p_i45325_2_, int p_i45325_3_) {
		super(armor, p_i45325_2_, p_i45325_3_);
	...
	String type) {
		if(stack.getItem() == MHFCRegItem.mhfcitemkirinhelm || stack.getItem() == MHFCRegItem.mhfcitemkirinchest || stack.getItem() == MHFCRegItem.mhfcitemkirinboots){
	...
	public void onArmorTick(World world, EntityPlayer player, ItemStack armor) {
		...
		{
		if(boots.getItem() == MHFCRegItem.mhfcitemkirinboots && legs.getItem() == MHFCRegItem.mhfcitemkirinlegs &&
		chest.getItem() == MHFCRegItem.mhfcitemkirinchest && helmet.getItem() == MHFCRegItem.mhfcitemkirinhelm)
		{
		}
		}
	}
