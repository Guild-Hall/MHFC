...
public class MHFCArmorMaterialHelper {
	...
	public static ArmorMaterial ArmorTigrex = EnumHelper.addArmorMaterial("tigrex", 300, new int[]{9, 17 , 13, 8}, 45);
	public static ArmorMaterial ArmorKirin = EnumHelper.addArmorMaterial("kirin", 325, new int[]{12, 18 , 14, 10}, 45);
	public static ArmorMaterial ArmorKirinS = EnumHelper.addArmorMaterial("kirinS", 700, new int[]{21, 35, 27, 18}, 70);
