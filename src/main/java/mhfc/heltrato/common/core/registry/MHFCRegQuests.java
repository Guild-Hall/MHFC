...
import mhfc.heltrato.common.network.message.MessageQuestVisual;
import mhfc.heltrato.common.network.message.MessageRequestQuestVisual;
import mhfc.heltrato.common.quests.GeneralQuest;
import mhfc.heltrato.common.quests.GoalDescription;
import mhfc.heltrato.common.quests.QuestDescription;
import mhfc.heltrato.common.quests.QuestFactory;
import mhfc.heltrato.common.quests.QuestVisualInformation;
		...
		public QuestDescription deserialize(JsonElement json, Type typeOfT,
			...
			if (!jsonAsObject.has("name")) {
				...
				String typeString = JsonUtils
						.getJsonObjectStringFieldValueOrDefault(jsonAsObject,
								"type", "hunting");
				QuestType type = mhfc.heltrato.common.quests.QuestVisualInformation.QuestType.Hunting;
				switch (typeString) {
					default :
						System.out
