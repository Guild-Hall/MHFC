...
import mhfc.heltrato.client.model.weapon.bowgun.ModelRathBowgun;
...
public class RenderBHRath implements IItemRenderer {

	private ModelRathBowgun weapon;

	public RenderBHRath() {
		weapon = new ModelRathBowgun();
	}
		...
		switch (type) {
			...
			case EQUIPPED : // render in third person
				...
				Minecraft.getMinecraft().renderEngine
						.bindTexture(new ResourceLocation(MHFCReference.weapon_bgh_rath_tex));
				...
				GL11.glRotatef(-180F, 0.0f, 0.0f, 1.0f); // rotate -150 ° on Z
															// axis
				GL11.glTranslatef(0.2F, -0.9F, -0.2F);// translate model to fit
														// in the hand of the
														// player
