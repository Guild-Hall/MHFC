...
import mhfc.heltrato.client.model.weapon.huntinghorn.ModelHHIvoryHorn;
...
public class RenderHHIvoryHorn implements IItemRenderer {

	private ModelHHIvoryHorn weapon;

	public RenderHHIvoryHorn() {
		weapon = new ModelHHIvoryHorn();
	}
