...
import mhfc.heltrato.client.model.weapon.ModelLSIronKatana;
...
public class RenderLSIronKatana implements IItemRenderer{
	
	private ModelLSIronKatana weapon;
	
	public RenderLSIronKatana(){
		weapon = new ModelLSIronKatana();
	}
     ...
     public void renderItem(ItemRenderType type, ItemStack item, Object... data) {
             ...
             case EQUIPPED: // render in third person
                     ...
                     Minecraft.getMinecraft().renderEngine.bindTexture(new ResourceLocation("mhfc:textures/weapons/(LS)ironkatana.png"));
                     ...
                     GL11.glTranslatef(-0.5F, -0.4F, 0.0F);  //translate model to fit in the hand of the player
