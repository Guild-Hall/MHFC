...
import mhfc.heltrato.client.model.weapon.hammer.ModelHRathalos;
...
public class RenderHRathalos implements IItemRenderer {

	private ModelHRathalos weapon;

	public RenderHRathalos() {
		weapon = new ModelHRathalos();
	}
		...
		switch (type) {
			...
			case EQUIPPED : // render in third person
				...
				Minecraft.getMinecraft().renderEngine
						.bindTexture(new ResourceLocation(MHFCReference.weapon_hm_rathalos_tex));
				...
				GL11.glRotatef(-120F, 0.0f, 0.0f, 1.0f); // rotate -150 ° on Z
															// axis
				GL11.glTranslatef(-0.4F, -0.6F, -0.0F); // translate model to
														// fit in the hand of
														// the player
