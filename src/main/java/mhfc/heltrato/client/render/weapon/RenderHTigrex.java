...
import mhfc.heltrato.client.model.weapon.ModelHTigrex;
...
public class RenderHTigrex implements IItemRenderer{
	
	private ModelHTigrex weapon;
	
	public RenderHTigrex(){
		weapon = new ModelHTigrex();
	}
     ...
     public void renderItem(ItemRenderType type, ItemStack item, Object... data) {
             ...
             case EQUIPPED: // render in third person
                     ...
                     Minecraft.getMinecraft().renderEngine.bindTexture(new ResourceLocation("mhfc:textures/weapons/(H)tigrex.png"));
                     ...
                     GL11.glTranslatef(-0.4F, -0.2F, -0.1F);  //translate model to fit in the hand of the player
