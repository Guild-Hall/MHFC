package mhfc.heltrato.client.render.weapon.greatsword;

import mhfc.heltrato.client.model.weapon.greatsword.ModelGSKirinThunderSword;
...
public class RenderGSKirinThunderSword implements IItemRenderer {

	private ModelGSKirinThunderSword weapon;

	public RenderGSKirinThunderSword() {
		weapon = new ModelGSKirinThunderSword();
	}
		...
		switch (type) {
			...
			case EQUIPPED : // render in third person
				...
				Minecraft.getMinecraft().renderEngine
						.bindTexture(new ResourceLocation(MHFCReference.weapon_gs_kirin_tex));
				...
				GL11.glRotatef(-120F, 0.0f, 0.0f, 1.0f); // rotate -150 ° on Z
															// axis
				GL11.glTranslatef(-0.4F, -0.3F, 0.0F); // translate model to fit
														// in the hand of the
														// player
