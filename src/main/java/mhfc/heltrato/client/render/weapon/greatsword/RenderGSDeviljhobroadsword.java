...
import mhfc.heltrato.client.model.weapon.greatsword.ModelGSDeviljhobroadsword;
...
public class RenderGSDeviljhobroadsword implements IItemRenderer {

	private ModelGSDeviljhobroadsword weapon;

	public RenderGSDeviljhobroadsword() {
		weapon = new ModelGSDeviljhobroadsword();
	}
		...
		switch (type) {
			...
			case EQUIPPED : // render in third person
				...
				Minecraft.getMinecraft().renderEngine
						.bindTexture(new ResourceLocation(MHFCReference.weapon_gs_deviljho_tex));
