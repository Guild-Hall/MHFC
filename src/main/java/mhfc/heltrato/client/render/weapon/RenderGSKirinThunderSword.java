...
import mhfc.heltrato.client.model.weapon.ModelGSKirinThunderSword;
	...
	public RenderGSKirinThunderSword() {
     ...
     public void renderItem(ItemRenderType type, ItemStack item, Object... data) {
             ...
             case EQUIPPED: // render in third person
                     ...
                     Minecraft.getMinecraft().renderEngine.bindTexture(new ResourceLocation("mhfc:textures/weapons/(GS)kirin.png"));
                     ...
                     GL11.glTranslatef(-0.4F, -0.3F, 0.0F);  //translate model to fit in the hand of the player
