package mhfc.heltrato.client.render.weapon.bowgun;

import mhfc.heltrato.client.model.weapon.bowgun.ModelBGLSpartacusFire;
...
public class RenderBGLSpartacusFire implements IItemRenderer {

	private ModelBGLSpartacusFire weapon;

	public RenderBGLSpartacusFire() {
		weapon = new ModelBGLSpartacusFire();
	}
		...
		switch (type) {
			...
			case EQUIPPED : // render in third person
				...
				Minecraft.getMinecraft().renderEngine
						.bindTexture(new ResourceLocation(MHFCReference.weapon_bgl_spartacusfire_tex));
