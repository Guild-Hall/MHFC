...
import mhfc.heltrato.client.model.weapon.hammer.ModelHTigrex;
		...
		switch (type) {
			...
			case EQUIPPED : // render in third person
				...
				Minecraft.getMinecraft().renderEngine
						.bindTexture(new ResourceLocation(MHFCReference.weapon_hm_tigrex_tex));
				...
				GL11.glRotatef(-120F, 0.0f, 0.0f, 1.0f); // rotate -150 ° on Z
															// axis
				GL11.glTranslatef(-0.4F, -0.2F, -0.1F); // translate model to
														// fit in the hand of
														// the player
