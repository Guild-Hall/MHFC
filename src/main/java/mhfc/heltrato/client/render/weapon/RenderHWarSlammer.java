...
import mhfc.heltrato.client.model.weapon.ModelHWarSlammer;
	...
	public RenderHWarSlammer() {
     ...
     public void renderItem(ItemRenderType type, ItemStack item, Object... data) {
             ...
             case EQUIPPED: // render in third person
                     ...
                     Minecraft.getMinecraft().renderEngine.bindTexture(new ResourceLocation("mhfc:textures/weapons/(H)warslammer.png"));
                     ...
                     GL11.glTranslatef(-0.35F, -0.6F, -0.15F);  //translate model to fit in the hand of the player
