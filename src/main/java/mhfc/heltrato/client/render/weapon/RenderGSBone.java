...
import mhfc.heltrato.client.model.weapon.ModelGSBone;
	...
	public RenderGSBone(){
     ...
     public void renderItem(ItemRenderType type, ItemStack item, Object... data) {
             ...
             case EQUIPPED: // render in third person
                     ...
                     Minecraft.getMinecraft().renderEngine.bindTexture(new ResourceLocation("mhfc:textures/weapons/(GS)bone.png"));
                     ...
                     GL11.glTranslatef(-0.4F, -0.5F, 0F);  //translate model to fit in the hand of the player
