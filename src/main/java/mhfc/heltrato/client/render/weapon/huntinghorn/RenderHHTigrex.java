...
import mhfc.heltrato.client.model.weapon.huntinghorn.ModelHHTigrex;
...
public class RenderHHTigrex implements IItemRenderer {

	private ModelHHTigrex weapon;

	public RenderHHTigrex() {
		weapon = new ModelHHTigrex();
	}
		...
		switch (type) {
			...
			case EQUIPPED : // render in third person
				...
				Minecraft.getMinecraft().renderEngine
						.bindTexture(new ResourceLocation(MHFCReference.weapon_hh_tigrex_tex));
