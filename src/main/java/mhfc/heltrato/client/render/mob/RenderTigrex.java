...
{
	private float scale;
	private static final ResourceLocation texture = new ResourceLocation("mhfc:textures/mobs/tigrex.png");
    ...
    {
        this.preRenderScale((EntityTigrex)par1EntityLivingBase, par2);
    }
