package mhfc.heltrato.client.container;

import mhfc.heltrato.client.crafting.MHFCCraftingManager;
import mhfc.heltrato.client.gui.slot.SlotHunterBench;
...
public class ContainerHunterBench extends Container
{
	...
	public ContainerHunterBench(InventoryPlayer par1InventoryPlayer, World par2World, int par3, int par4, int par5)
	{
		this.worldObj = par2World;
		this.posX = par3;
		this.posY = par4;
		this.posZ = par5;
		this.addSlotToContainer(new SlotHunterBench(par1InventoryPlayer.player, this.craftMatrix, this.craftResult, 0, 124 + 8, 35 + 1));
		int var6;
		int var7;
