...
public class ModelBGLShooterBarrel extends ModelBase
{
  //fields
  ...
  public ModelBGLShooterBarrel()
  {
      ...
      Shape2.addBox(0F, 0F, -2F, 1, 2, 3);
      Shape2.setRotationPoint(2F, 1F, 3.5F);
      Shape2.setTextureSize(32, 32);
      Shape2.mirror = true;
      setRotation(Shape2, -0.2617994F, 1.570796F, 0F);
      Shape3 = new ModelRenderer(this, 0, 12);
      Shape3.addBox(0F, 0F, -2F, 1, 1, 2);
      Shape3.setRotationPoint(0F, -1F, 3F);
  ...
  public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5, Entity par)
  {
    super.setRotationAngles(f, f1, f2, f3, f4, f5, par);
  }
