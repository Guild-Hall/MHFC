...
import mhfc.net.common.network.message.MessageQuestScreenInit;
import mhfc.net.common.network.message.MessageQuestVisual;
import mhfc.net.common.network.message.MessageRequestQuestVisual;
