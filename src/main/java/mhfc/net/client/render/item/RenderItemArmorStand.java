...
public class RenderItemArmorStand implements IItemRenderer {
	...
	public void renderItem(ItemRenderType type, ItemStack item, Object... data) {
		...
		case INVENTORY:
			renderThisItem(0.9F, 1.2F, 1.0F, 180F, 0F, 0F, 1F); break;
		default:
			break;
		}
	...
	private void renderThisItem(float x, float y, float z, float rotateX, float rotateY, float rotateZ, float angle) {
		...
		GL11.glPushMatrix();
		Minecraft.getMinecraft().renderEngine.bindTexture(new ResourceLocation("mhfc:textures/tile/armorstand.png"));
