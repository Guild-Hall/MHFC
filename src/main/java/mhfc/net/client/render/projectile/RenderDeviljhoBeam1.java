...
public class RenderDeviljhoBeam1 extends Render<EntityDeviljhoBeam1> {
	...
	public void doRender(EntityDeviljhoBeam1 solarBeam, double x, double y, double z, float yaw, float delta) {
		...
		GlStateManager.translate(
				solarBeam.collidePosX - solarBeam.posX,
				solarBeam.collidePosY - solarBeam.posY,
				solarBeam.collidePosZ - solarBeam.posZ);
		renderEnd(frame, solarBeam.blockSide);
		GlStateManager.depthMask(true);
		GlStateManager.translate(
				solarBeam.posX - solarBeam.collidePosX,
				solarBeam.posY - solarBeam.collidePosY,
				solarBeam.posZ - solarBeam.collidePosZ);
	...
	public static final VertexFormat POSITION_TEX_LMAP = new VertexFormat().addElement(DefaultVertexFormats.POSITION_3F)
