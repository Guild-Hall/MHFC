...
public class RenderGSDeadlySerpentblade implements IItemRenderer {

	private ModelGSDeadlySerpentBlade weapon;

	public RenderGSDeadlySerpentblade() {
		weapon = new ModelGSDeadlySerpentBlade();
	}
		...
		switch (type) {
			...
			case EQUIPPED : // render in third person
				...
				Minecraft.getMinecraft().renderEngine
						.bindTexture(new ResourceLocation(MHFCReference.weapon_gs_deadlyserpentblade_tex));
