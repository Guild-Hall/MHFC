...
public class RenderHHWarDrums implements IItemRenderer {

	private ModelHHWarDrums weapon;

	public RenderHHWarDrums() {
		weapon = new ModelHHWarDrums();
	}
		...
		switch (type) {
			...
			case EQUIPPED : // render in third person
				...
				Minecraft.getMinecraft().renderEngine
						.bindTexture(new ResourceLocation(MHFCReference.weapon_hh_wardrums_tex));
