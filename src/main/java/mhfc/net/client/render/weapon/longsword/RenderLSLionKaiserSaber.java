...
public class RenderLSLionKaiserSaber implements IItemRenderer {

	private ModelLSSaber weapon;

	public RenderLSLionKaiserSaber() {
		weapon = new ModelLSSaber();
	}
		...
		switch (type) {
			...
			case EQUIPPED : // render in third person
				...
				Minecraft.getMinecraft().renderEngine
						.bindTexture(new ResourceLocation(MHFCReference.weapon_ls_lionkaisersaber_tex));
