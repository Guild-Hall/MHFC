...
public class RenderLSLionDanceSaber implements IItemRenderer {

	private ModelLSSaber weapon;

	public RenderLSLionDanceSaber() {
		...
		switch (type) {
			...
			case EQUIPPED : // render in third person
				...
				Minecraft.getMinecraft().renderEngine
						.bindTexture(new ResourceLocation(MHFCReference.weapon_ls_liondancesaber_tex));
