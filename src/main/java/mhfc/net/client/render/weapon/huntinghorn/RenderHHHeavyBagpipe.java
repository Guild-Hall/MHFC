...
public class RenderHHHeavyBagpipe implements IItemRenderer {

	private ModelHHHeavyBagpipe weapon;

	public RenderHHHeavyBagpipe() {
		weapon = new ModelHHHeavyBagpipe();
	}
		...
		switch (type) {
			...
			case EQUIPPED : // render in third person
				...
				Minecraft.getMinecraft().renderEngine
						.bindTexture(new ResourceLocation(MHFCReference.weapon_hh_heavybagpipe_tex));
