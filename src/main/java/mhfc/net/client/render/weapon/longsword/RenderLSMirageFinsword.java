...
public class RenderLSMirageFinsword implements IItemRenderer {

	private ModelLSMirageFinsword weapon;

	public RenderLSMirageFinsword() {
		weapon = new ModelLSMirageFinsword();
	}
		...
		switch (type) {
			...
			case EQUIPPED : // render in third person
				...
				Minecraft.getMinecraft().renderEngine
						.bindTexture(new ResourceLocation(MHFCReference.weapon_ls_miragefinsword_tex));
