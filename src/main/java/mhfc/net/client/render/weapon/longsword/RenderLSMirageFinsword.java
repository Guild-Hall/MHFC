...
public class RenderLSMirageFinsword extends RenderWeapon<ModelLSMirageFinsword> {

	public RenderLSMirageFinsword() {
		super(new ModelLSMirageFinsword(), MHFCReference.weapon_ls_miragefinsword_tex, 1.3f);
	}
