...
public class RenderHHEliteBagpipe extends RenderHuntingHorn<ModelHHEliteBagpipe> {

	public RenderHHEliteBagpipe() {
		super(new ModelHHEliteBagpipe(), MHFCReference.weapon_hh_elitebagpipe_tex, 1.7f);
	}
