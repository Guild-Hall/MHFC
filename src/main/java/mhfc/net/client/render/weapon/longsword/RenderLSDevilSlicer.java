...
public class RenderLSDevilSlicer implements IItemRenderer {

	private ModelLSEagerCleaver weapon;

	public RenderLSDevilSlicer() {
		...
		switch (type) {
			...
			case EQUIPPED : // render in third person
				...
				Minecraft.getMinecraft().renderEngine
						.bindTexture(new ResourceLocation(MHFCReference.weapon_ls_devilslicer_tex));
