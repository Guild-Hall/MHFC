...
public class RenderHHDarkThornTrumpet implements IItemRenderer {

	private ModelHHDarkThornTrumpet weapon;

	public RenderHHDarkThornTrumpet() {
		weapon = new ModelHHDarkThornTrumpet();
	}
		...
		switch (type) {
			...
			case EQUIPPED : // render in third person
				...
				Minecraft.getMinecraft().renderEngine
						.bindTexture(new ResourceLocation(MHFCReference.weapon_hh_darkthorntrumpet_tex));
