		 ...
		 int usingItem = ((WeaponBHunter)item.getItem()).usingItem;
             ...
             case EQUIPPED: //3rd person
            	 ...
            	 if((((Entity)data[1] instanceof EntityPlayer)) && (((EntityPlayer)data[1]).getCurrentEquippedItem() != null)){
            		if(usingItem < 5){
            			Minecraft.getMinecraft().renderEngine.bindTexture(new ResourceLocation("mhfc:textures/weapons/bow/hunterbow0.png"));
            		}
            		if((usingItem >- 5) && (usingItem < 35)){
            			Minecraft.getMinecraft().renderEngine.bindTexture(new ResourceLocation("mhfc:textures/weapons/bow/hunterbow1.png"));
            		}
            		if((usingItem >= 35))
            		{
            			Minecraft.getMinecraft().renderEngine.bindTexture(new ResourceLocation("mhfc:textures/weapons/bow/hunterbow2.png"));
            		}else{
            			Minecraft.getMinecraft().renderEngine.bindTexture(new ResourceLocation("mhfc:textures/weapons/bow/hunterbow0.png"));
            		}
            		scale = 1.5f;
                    ...
                    GL11.glRotatef(-180, 0.0f, 0.0f, 1.0f);  // rotate -150 ° on Z axis
                    GL11.glTranslatef(-0.0F, -0.1F, -0.3F);  //translate model to fit in the hand of the player
