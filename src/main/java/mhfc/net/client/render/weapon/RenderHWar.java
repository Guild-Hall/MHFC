...
public class RenderHWar implements IItemRenderer{
	
	private ModelHWar weapon;
	
	public RenderHWar() {
		weapon = new ModelHWar();
	}
     ...
     public void renderItem(ItemRenderType type, ItemStack item, Object... data) {
             ...
             case EQUIPPED: // render in third person
                     ...
                     Minecraft.getMinecraft().renderEngine.bindTexture(new ResourceLocation("mhfc:textures/weapons/(H)warhammer.png"));
                     ...
                     GL11.glTranslatef(-0.4F, -0.5F, 0.05F);  //translate model to fit in the hand of the player
