...
public class RenderHHGreatBagpipe implements IItemRenderer {

	private ModelHHGreatBagpipe weapon;

	public RenderHHGreatBagpipe() {
		weapon = new ModelHHGreatBagpipe();
	}
		...
		switch (type) {
			...
			case EQUIPPED : // render in third person
				...
				Minecraft.getMinecraft().renderEngine
						.bindTexture(new ResourceLocation(MHFCReference.weapon_hh_greatbagpipe_tex));
