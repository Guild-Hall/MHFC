...
public class RenderHHMogwardDrums implements IItemRenderer {

	private ModelHHMogwardDrums weapon;

	public RenderHHMogwardDrums() {
		weapon = new ModelHHMogwardDrums();
	}
		...
		switch (type) {
			...
			case EQUIPPED : // render in third person
				...
				Minecraft.getMinecraft().renderEngine
						.bindTexture(new ResourceLocation(MHFCReference.weapon_hh_mogwarddrums_tex));
