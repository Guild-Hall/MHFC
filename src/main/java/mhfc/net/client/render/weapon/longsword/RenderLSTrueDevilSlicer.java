...
public class RenderLSTrueDevilSlicer extends RenderWeapon<ModelLSEagerCleaver> {

	public RenderLSTrueDevilSlicer() {
		super(new ModelLSEagerCleaver(), MHFCReference.weapon_ls_truedevilslicer_tex, 1.3f);
	}
