...
import mhfc.net.client.model.weapon.longsword.ModelLSEagerCleaver;
...
public class RenderLSTrueDevilSlicer implements IItemRenderer {

	private ModelLSEagerCleaver weapon;

	public RenderLSTrueDevilSlicer() {
		weapon = new ModelLSEagerCleaver();
	}
		...
		switch (type) {
			...
			case EQUIPPED : // render in third person
				...
				Minecraft.getMinecraft().renderEngine
						.bindTexture(new ResourceLocation(MHFCReference.weapon_ls_truedevilslicer_tex));
