...
public class RenderLSEagerCleaver implements IItemRenderer {

	private ModelLSEagerCleaver weapon;

	public RenderLSEagerCleaver() {
		...
		switch (type) {
			...
			case EQUIPPED : // render in third person
				...
				Minecraft.getMinecraft().renderEngine
						.bindTexture(new ResourceLocation(MHFCReference.weapon_ls_eagercleaver_tex));
