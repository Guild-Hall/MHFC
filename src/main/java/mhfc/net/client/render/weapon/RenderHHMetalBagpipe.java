...
import mhfc.net.client.model.weapon.ModelHHMetalBagpipe;
import mhfc.net.client.model.weapon.ModelHKirinSpark;
...
public class RenderHHMetalBagpipe implements IItemRenderer{
	
	private ModelHHMetalBagpipe weapon;
	
	public RenderHHMetalBagpipe() {
		weapon = new ModelHHMetalBagpipe();
	}
     ...
     public void renderItem(ItemRenderType type, ItemStack item, Object... data) {
             ...
             case EQUIPPED: // render in third person
                     ...
                     Minecraft.getMinecraft().renderEngine.bindTexture(new ResourceLocation("mhfc:textures/weapons/(HH)metalbagpipe.png"));
                     ...
                     GL11.glTranslatef(-0.4F, -0.4F, 0.05F);  //translate model to fit in the hand of the player
