...
public class RenderLSPhantomMirage implements IItemRenderer {

	private ModelLSMirageFinsword weapon;

	public RenderLSPhantomMirage() {
		...
		switch (type) {
			...
			case EQUIPPED : // render in third person
				...
				Minecraft.getMinecraft().renderEngine
						.bindTexture(new ResourceLocation(MHFCReference.weapon_ls_phantommirage_tex));
