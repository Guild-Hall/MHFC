...
public class RenderLSPhantomMirage extends RenderWeapon<ModelLSMirageFinsword> {

	public RenderLSPhantomMirage() {
		super(new ModelLSMirageFinsword(), MHFCReference.weapon_ls_phantommirage_tex, 1.3f);
	}
