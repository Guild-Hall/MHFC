...
{
	private float scale;
	private static final ResourceLocation texture = new ResourceLocation("mhfc:textures/mobs/kirin.png");
    ...
    public void doRender(Entity entity, double d, double d1, double d2, float f, float f1)
    {
    	...
    	renderElectricField((float)d, (float)d1, (float)d2, (EntityLiving)entity);
