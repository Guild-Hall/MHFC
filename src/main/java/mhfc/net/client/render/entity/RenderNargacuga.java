...
public class RenderNargacuga extends RenderAnimatedModel<Nargacuga> {
	...
	private void renderEyeFollow(Nargacuga nargacuga, Queue<Vec3d> queue) {
	...
	@Override
	public void doRender(Nargacuga entity, double x, double y, double z, float yaw, float partialTicks) {
		super.doRender(entity, x, y, z, yaw, partialTicks);
	}

	@Override
	protected float getDeathMaxRotation(Nargacuga entity) {
		return 0;
	}
	...
	@Override
	protected void renderModel(Nargacuga entity, float _1, float _2, float _3, float _4, float _5, float _6) {
		super.renderModel(entity, _1, _2, _3, _4, _5, _6);

		Nargacuga nargacuga = Nargacuga.class.cast(entity);
