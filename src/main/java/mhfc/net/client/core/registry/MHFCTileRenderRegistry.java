...
public class MHFCTileRenderRegistry {
	...
	public static void init() {
		...
		ClientRegistry.bindTileEntitySpecialRenderer(TileStunTrap.class,
				new RenderStunTrap());
		ClientRegistry.bindTileEntitySpecialRenderer(TileArmorStandBase.class,
				new RenderArmorStandBase());
		ClientRegistry.bindTileEntitySpecialRenderer(TileArmorStand.class,
				new RenderArmorStand());
