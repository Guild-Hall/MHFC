...
public class MHMDModelLoader implements IModelCustomLoader {
	...
	public ModelMHMD loadInstance(ResourceLocation resource,
		...
		// when that is null.
		ModelMHMD model = new ModelMHMD(resource, resManager);
		if (register) {
	 ...
	 */
	public ModelMHMD loadChecked(ResourceLocation resLocation,
	 ...
	 * @return the loaded model, never null
	 */
	public ModelMHMD loadFromStream(DataInputStream dis, String filename)
			throws ModelFormatException {
		MHFCMain.logger.trace(String.format(
