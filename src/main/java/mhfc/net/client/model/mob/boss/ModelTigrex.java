...
public class ModelTigrex extends PartTickModelBase {
	...
	public void animate(EntityTigrex tigrex, float f, float f1, float f2,
		...
		// float neckAnimY = f3 / (180F / PI);
		// float neckAnimX = f4 / (180F / PI);
		float footAnimX = MathHelper.cos(f * 0.6662F) * 1.4F * f1;
		float footAnimY = MathHelper.cos(f * 0.6662F + (float) Math.PI) * 1.4F
				* f1;
