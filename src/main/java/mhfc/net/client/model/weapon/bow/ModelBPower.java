...
import mhfc.net.common.weapon.range.bow.iBowAnim;
...
public class ModelBPower extends ModelBase implements iBowAnim
{
  ...
  public ModelBPower()
  {
    ...
    basepoint.addBox(1F, 0F, 0F, 1, 1, 1);
    basepoint.setRotationPoint(-3F, 0.1F, 0F);
    basepoint.setTextureSize(128, 128);
    basepoint.mirror = true;
    setRotation(basepoint, 0F, 0F, 0.1745329F);
    baseA = new ModelRenderer(this, 0, 43);
    baseA.addBox(-1F, -10F, -1F, 2, 10, 2);
    baseA.setRotationPoint(-1F, 0.5F, 0F);
    ...
    spearB.addBox(-4F, -1F, -0.5F, 12, 1, 1);
    spearB.setRotationPoint(0F, 2F, 0F);
    spearB.setTextureSize(128, 128);
    spearB.mirror = true;
    setRotation(spearB, 0F, 0F, 0F);
    spearPinA = new ModelRenderer(this, 0, 75);
    spearPinA.addBox(-1F, -1F, -1F, 2, 2, 2);
    ...
    spearPinB.addBox(-1F, -1F, -1F, 2, 2, 2);
    spearPinB.setRotationPoint(-4F, 1.5F, 0F);
    ...
    stringBase.addBox(-1F, -2F, -0.5F, 1, 29, 1);
    stringBase.setRotationPoint(4F, -12F, 0F);
    ...
    stringU.setRotationPoint(2.8F, -13F, 0F);
    ...
    stringL.setRotationPoint(7F, 0F, 0F);
