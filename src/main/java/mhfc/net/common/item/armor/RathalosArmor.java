...
public class RathalosArmor extends ItemArmorMHFC {
	private static final String[] names = { Libraries.armor_rathalos_helm_name,
			Libraries.armor_rathalos_chest_name, Libraries.armor_rathalos_legs_name,
			Libraries.armor_rathalos_boots_name };

	public RathalosArmor(EntityEquipmentSlot type) {
		super(ArmorMaterialReception.ArmorRathalos, ItemRarity.R04, type);
	...
	protected ModelBiped getBipedModel(EntityEquipmentSlot armorSlot) {
		return ArmorModelReception.rathalos;
	}
