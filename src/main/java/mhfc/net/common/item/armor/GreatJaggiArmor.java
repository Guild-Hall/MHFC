...
public class GreatJaggiArmor extends ItemArmor {
	...
	public GreatJaggiArmor(int type) {
		super(MHFCArmorMaterialHelper.ArmorGreatJaggi, 4, type);
	...
	public String getArmorTexture(ItemStack stack, Entity entity, int slot, String type) {
		if (stack.getItem() == MHFCItemRegistry.getRegistry().armor_jaggi_helm
				|| stack.getItem() == MHFCItemRegistry.getRegistry().armor_jaggi_chest
				|| stack.getItem() == MHFCItemRegistry.getRegistry().armor_jaggi_boots) {
			return MHFCReference.armor_greatjaggi_tex1;
		}
		if (stack.getItem() == MHFCItemRegistry.getRegistry().armor_jaggi_legs) {
			return MHFCReference.armor_greatjaggi_tex2;
		}
		return null;
	}
	...
	public ModelBiped getArmorModel(EntityLivingBase entityLiving, ItemStack itemStack, int armorSlot) {
		...
		if (type == 1 || type == 3 || type == 0) {
			armorModel = MHFCArmorModelHelper.jaggi;
		}
		if (armorModel == null) {
			return null;
		}
	...
	public void onArmorTick(World world, EntityPlayer player, ItemStack itemstack) {
		...
		if (boots != null && legs != null && chest != null) {
			if (boots.getItem() == MHFCItemRegistry.getRegistry().armor_jaggi_boots
					&& legs.getItem() == MHFCItemRegistry.getRegistry().armor_jaggi_legs
					&& chest.getItem() == MHFCItemRegistry.getRegistry().armor_jaggi_chest) {}
		}
	}
}
