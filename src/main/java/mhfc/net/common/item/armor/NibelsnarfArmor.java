...
public class NibelsnarfArmor extends ItemArmor {
	private static final String[] names = {
			MHFCReference.armor_nibelsnarf_helm_name,
			MHFCReference.armor_nibelsnarf_chest_name,
			MHFCReference.armor_nibelsnarf_legs_name,
	...
	public NibelsnarfArmor(int type) {
	...
	public String getArmorTexture(ItemStack stack, Entity entity, int slot,
			String type) {
		if (stack.getItem() == MHFCItemRegistry.armor_nibelsnarf_helm
				|| stack.getItem() == MHFCItemRegistry.armor_nibelsnarf_chest
				|| stack.getItem() == MHFCItemRegistry.armor_nibelsnarf_boots) {
			return MHFCReference.armor_nibelsnarf_tex1;
		}
		if (stack.getItem() == MHFCItemRegistry.armor_nibelsnarf_legs) {
			return MHFCReference.armor_nibelsnarf_tex2;
		}
		return null;
	}
	...
	public ModelBiped getArmorModel(EntityLivingBase entityLiving,
		...
		if (type == 1 || type == 3 || type == 0) {
			armorModel = MHFCArmorModelHelper.nibelsnarf;
		}
		if (armorModel == null)
			return null;
