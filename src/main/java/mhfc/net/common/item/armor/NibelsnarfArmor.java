...
public class NibelsnarfArmor extends ItemArmor {
	...
	public String getArmorTexture(ItemStack stack, Entity entity, int slot, String type) {
		if (stack.getItem() == MHFCItemRegistry.getRegistry().armor_nibelsnarf_helm
				|| stack.getItem() == MHFCItemRegistry.getRegistry().armor_nibelsnarf_chest
				|| stack.getItem() == MHFCItemRegistry.getRegistry().armor_nibelsnarf_boots) {
			return MHFCReference.armor_nibelsnarf_tex1;
		}
		if (stack.getItem() == MHFCItemRegistry.getRegistry().armor_nibelsnarf_legs) {
