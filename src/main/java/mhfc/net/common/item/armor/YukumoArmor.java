...
public class YukumoArmor extends ItemArmor {
	...
	private static final String[] icons = { MHFCReference.armor_yukumo_helm_icon, MHFCReference.armor_yukumo_chest_icon,
			MHFCReference.armor_yukumo_legs_icon, MHFCReference.armor_yukumo_boots_icon };
