...
public class MHFCExplosion extends Explosion
{
	...
	public void func_77278_a()
	{
				...
				for (int var5 = 0; var5 < this.field_77289_h; var5++)
				{
					if ((var3 == 0) || (var3 == this.field_77289_h - 1) || (var4 == 0) || (var4 == this.field_77289_h - 1) || (var5 == 0) || (var5 == this.field_77289_h - 1))
					{
						...
						for (float var21 = 0.3F; var14 > 0.0F; var14 -= var21 * 0.75F)
						{
							...
							{
								float f3 = this.exploder != null ? this.exploder.func_145772_a(this, this.worldObj, var22, var23, var24, block) : block.getExplosionResistance(this.exploder, this.worldObj, var22, var23, var24, this.explosionX, this.explosionY, this.explosionZ);
							}
		...
		int var3 = MathHelper.floor_double(this.explosionX - this.explosionSize - 1.0D);
		...
		List var9 = this.worldObj.getEntitiesWithinAABBExcludingEntity(this.exploder, AxisAlignedBB.getBoundingBox(var3, var5, var7, var4, var27, var28));
		...
		for (int var11 = 0; var11 < var9.size(); var11++)
		{
			...
			if (var13 <= 1.0D)
			{
				...
				double var17 = var30.posY + var30.getEyeHeight() - this.explosionY;
				...
				if (var32 != 0.0D)
				{
					...
					float power = 8.0F;
					if (this.lessenDamage) power = 6.0F;
					DamageSource source = DamageSource.setExplosionSource(this);
					if ((this.useEntity) && (this.exploder != null) && ((this.exploder instanceof EntityLiving))) source = DamageSource.causeMobDamage((EntityLiving)this.exploder);
					var30.attackEntityFrom(source, (int)((var33 * var33 + var33) / 2.0D * power * this.explosionSize + 1.0D));
					...
					{
						this.field_77288_k.put((EntityPlayer)var30, Vec3.createVectorHelper(var15 * var33, var17 * var33, var19 * var33));
					}
				}
			}
		}
	...
	public void func_77279_a(boolean par1)
	{
		...
		while (var2.hasNext())
		{
			...
			if (block.getMaterial() != Material.air)
			{
				...
				{
					block.dropBlockAsItemWithChance(this.worldObj, var4, var5, var6, this.worldObj.getBlockMetadata(var4, var5, var6), 1.0F / this.explosionSize, 0);
				}
	...
	public void explode(boolean particles) {
		...
		if ((this.destroyBlocks) && ((this.worldObj instanceof WorldServer))) {
			Iterator var11 = this.worldObj.playerEntities.iterator();
			while (var11.hasNext()) {
				EntityPlayer var12 = (EntityPlayer)var11.next();

				if (var12.getDistanceSq(this.explosionX, this.explosionY, this.explosionZ) < 4096.0D)
					((EntityPlayerMP)var12).playerNetServerHandler.sendPacket(new S27PacketExplosion(this.explosionX, this.explosionY, this.explosionZ, this.explosionSize, this.affectedBlockPositions, (Vec3)func_77277_b().get(var12)));
			}
		}
	}
