...
public class QuestRunningInformationFactory
	...
	public JsonElement serialize(IVisualInformation information,
		...
		JsonObject holder = QuestFactory.getQuestVisualInformationFactory(
