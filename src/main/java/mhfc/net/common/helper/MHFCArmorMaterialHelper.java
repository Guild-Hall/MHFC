...
public class MHFCArmorMaterialHelper {
	...
	// Basic Armors
	public static final ArmorMaterial ArmorYukumo = EnumHelper.addArmorMaterial         ("yukumo", durA, new int[]  {2, 4, 3, 2}, enchant);
	public static final ArmorMaterial ArmorCephalos = EnumHelper.addArmorMaterial       ("cepha", durA, new int[]   {2, 4, 4, 3}, enchant);
