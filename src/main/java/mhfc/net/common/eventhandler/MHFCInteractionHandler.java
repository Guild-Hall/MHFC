...
public class MHFCInteractionHandler
	implements
		IMessageHandler<MessageMHFCInteraction, IMessage> {
	...
	public static class MHFCInteractionEvent extends Event {
		...
		public MHFCInteractionEvent(EntityPlayerMP player,
			MessageMHFCInteraction message, Interaction interaction) {
			this.player = player;
	...
	public static class MHFCInteractionNewQuestEvent
		extends
			MHFCInteractionEvent {
		public MHFCInteractionNewQuestEvent(EntityPlayerMP player,
	...
	public static class MHFCInteractionAcceptQuestEvent
		extends
			MHFCInteractionEvent {
		public MHFCInteractionAcceptQuestEvent(EntityPlayerMP player,
			MessageMHFCInteraction message) {
	...
	public static class MHFCInteractionStartQuestEvent
		extends
			MHFCInteractionEvent {
		public MHFCInteractionStartQuestEvent(EntityPlayerMP player,
			MessageMHFCInteraction message) {
	...
	public static class MHFCInteractionEndQuestEvent
		extends
			MHFCInteractionEvent {
		public MHFCInteractionEndQuestEvent(EntityPlayerMP player,
			MessageMHFCInteraction message) {
	...
	public static class MHFCInteractionForfeitQuestEvent
		extends
			MHFCInteractionEvent {
		public MHFCInteractionForfeitQuestEvent(EntityPlayerMP player,
			MessageMHFCInteraction message) {
	...
	public static class MHFCInteractionModReloadEvent
		extends
			MHFCInteractionEvent {
		public MHFCInteractionModReloadEvent(EntityPlayerMP player,
			MessageMHFCInteraction message) {
		...
		switch (message.getInteraction()) {
			case NEW_QUEST :
				FMLCommonHandler.instance().bus().post(
					new MHFCInteractionNewQuestEvent(player, message));
				break;
			case ACCEPT_QUEST :
				FMLCommonHandler.instance().bus().post(
					new MHFCInteractionAcceptQuestEvent(player, message));
				break;
			case START_QUEST :
				FMLCommonHandler.instance().bus().post(
					new MHFCInteractionStartQuestEvent(player, message));
				break;
			case END_QUEST :
				FMLCommonHandler.instance().bus().post(
					new MHFCInteractionEndQuestEvent(player, message));
				break;
			case FORFEIT_QUEST :
				FMLCommonHandler.instance().bus().post(
					new MHFCInteractionForfeitQuestEvent(player, message));
				break;
			case MOD_RELOAD :
				FMLCommonHandler.instance().bus().post(
