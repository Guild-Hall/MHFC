...
public class ComponentMelee {
	...
	public void setThisItemProperties() {
		if (weaponMaterial == null) {
			...
			item.setMaxDamage(
					(int) (weaponSpecs.durabilityBase + weaponMaterial.getMaxUses() * weaponSpecs.damageMult));
		}
	...
	public float getBlockDamage(ItemStack itemstack, Block block) {
		...
		return material != Material.plants && material != Material.vine && material != Material.coral
				&& material != Material.leaves && material != Material.gourd ? 1.0F : weaponSpecs.blockDamage;
	}
