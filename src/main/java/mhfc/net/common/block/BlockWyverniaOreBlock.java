...
public class BlockWyverniaOreBlock extends Block {
	public static enum WyverniaOreBlockSubType
			implements
				SubTypedItem.SubTypeEnum<Block> {
		MACHALITE(MHFCReference.block_machalite_name,
				MHFCReference.block_machalite_tex), //
		CARBALITE(MHFCReference.block_carbalite_name,
				MHFCReference.block_carbalite_tex), //
		ELTALITE(MHFCReference.block_eltalite_name,
				MHFCReference.block_eltalite_tex), //
		DRAGONITE(MHFCReference.block_dragonite_name,
				MHFCReference.block_dragonite_tex);
