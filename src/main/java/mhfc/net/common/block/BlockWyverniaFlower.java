...
public class BlockWyverniaFlower extends BlockWyverniaDecor {
	public static enum WyverniaFlowerSubType
			implements
				SubTypedItem.SubTypeEnum<Block> {
		CARNCASE(MHFCReference.block_carncase_name,
				MHFCReference.block_carncase_tex), //
		...
		SPINDEL(MHFCReference.block_spindel_name,
				MHFCReference.block_spindel_tex);
		...
		public Block getBaseItem() {
			return MHFCBlockRegistry.mhfcblockflowers;
		}
	}
	...
	public boolean isValidPosition(World world, int x, int y, int z,
		...
		return block == MHFCBlockRegistry.mhfcblockdirt
				|| block == MHFCBlockRegistry.mhfcblockgrass
				|| block == Blocks.glass;
	}
