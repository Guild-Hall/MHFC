...
public class ResourceInterface {
	...
	public static final String area_snowymountains_name = "mhfc.area.snowymountains.name";
	...
	public static final String entity_deviljhobeam1_name = "beam";
	public static final String entity_deviljhobeam2_name = "laserbreath";
	...
	public static final String item_delex_basename = "delex";
	public static final String item_delex0_name = item_delex_basename + "bigfin";
	public static final String item_delex1_name = item_delex_basename + "qualityfin";
