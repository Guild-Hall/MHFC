...
public class Material {
	...
	public static final ArmorMaterial yukomo = EnumHelper
			.addArmorMaterial("yukumo", ResourceInterface.armor_yukumo_tex, 1500, new int[] { 2, 2, 2, 2  }, enchant, null, 1500);
	...
	public static final ArmorMaterial barroth = EnumHelper
			.addArmorMaterial("barroth", ResourceInterface.armor_barroth_tex, 1500, new int[] { 3, 3, 2, 2 }, enchant, null, 1500);
	public static final ArmorMaterial tigrex = EnumHelper
			.addArmorMaterial("tigrex", ResourceInterface.armor_tigrex_tex, 1500, new int[] { 3, 3, 3, 3 }, enchant, null, 1500);
	...
	public static final ArmorMaterial deviljho = EnumHelper
			.addArmorMaterial("deviljho", ResourceInterface.armor_deviljho_tex, 1500, new int[] { 4, 5, 4, 4}, enchant, null, 1500);
