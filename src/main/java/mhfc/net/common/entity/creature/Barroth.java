...
public class Barroth extends CreatureAttributes<Barroth> {
	...
	protected void applyEntityAttributes() {
		...
		this.getEntityAttribute(SharedMonsterAttributes.MAX_HEALTH).setBaseValue(9520D);
	...
	protected IActionManager<Barroth> constructActionManager() {
		...
		followUpManager.registerAction(setDeathAction(new AIDeath(this, "mhfc:models/Barroth/BarrothDeath.mcanm",
				MHFCSoundRegistry.getRegistry().barrothDeath)));

		followUpManager.registerAction(
				new AIWander<Barroth>(this, "mhfc:models/Barroth/walknew.mcanm", 67, 1, 0.1F, 0.7F, 0, 59, 1, 30));
