...
public class GreatJaggi extends CreatureAttributes<GreatJaggi> {
	...
	protected IActionManager<GreatJaggi> constructActionManager() {
		...
		actionManager.registerAction(new AIBite(this,
				"mhfc:models/GreatJaggi/GreatJaggiBite.mcanm", 30, 17, 35, 5,
				MHFCSoundRegistry.getRegistry().greatJaggiBite, 5.5F, true, 10,
				25));
		actionManager.registerAction(new AIAngleWhip<>(
				"mhfc:models/GreatJaggi/GreatJaggiTailWhip.mcanm", 40, 21, 66,
				5F, MHFCSoundRegistry.getRegistry().greatJaggiTailWhip, 5, 4, 2,
				180, 8F));
		...
		actionManager.registerAction(setDeathAction(new AIDeath(this,
