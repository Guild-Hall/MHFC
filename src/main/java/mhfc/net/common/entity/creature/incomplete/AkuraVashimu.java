...
public class AkuraVashimu extends CreatureAttributes<AkuraVashimu> {
	...
	protected IActionManager<AkuraVashimu> constructActionManager() {
		...
		manager.registerAction(new AIBreathe(this,
				"mhfc:models/akuravashimu/breath.mcanm", 60, 2f));
		manager.registerAction(new AIIdle(this,
				"mhfc:models/akuravashimu/look1.mcanm", 40, 0.5F));
		manager.registerAction(new AIWander<AkuraVashimu>(this,
				"mhfc:models/akuravashimu/walk1.mcanm", 160, 1, 0.1F, 0.2F, 20,
				139, 1, 5));
		manager.registerAction(
				new AIBite(this, "mhfc:models/akuravashimu/damage1.mcanm", 70,
						32, 80, 10, null, 12F, true, 32, 36));
		manager.registerAction(new Jump1());
		manager.registerAction(new Move1());
		manager.registerAction(new AIDeath(this,
				"mhfc:models/akuravashimu/death.mcanm", null));
		// Wander i added + 10 ticks to the animation length to make sure that
		// there is allowance on loop.
		// followUpManager.registerAction(new
		// AIWander<AkuraVashimu>(this,"mhfc:models/akuravashimu/walk.mcanm",110,1,0.12F,0.7F,0,89,1,10));
	...
	protected void initEntityAI() {
		...
		targetTasks.addTask(1, new EntityAINearestAttackableTarget<>(this,
				EntityVillager.class, 0, true, true, null));
