...
public class ColorSystem {
	...
	public static final String dark_green = ENUMDARK_GREEN.toString();
	public static final String dark_aqua = ENUMDARK_AQUA.toString();
	public static final String dark_red = ENUMDARK_RED.toString();
	public static final String dark_purple = ENUMDARK_PURPLE.toString();
	public static final String gold = ENUMGOLD.toString();
	public static final String gray = ENUMGRAY.toString();
	public static final String dark_gray = ENUMDARK_GRAY.toString();
	public static final String lavender = ENUMLAVENDER.toString();
	public static final String green = ENUMGREEN.toString();
	public static final String aqua = ENUMAQUA.toString();
	public static final String red = ENUMRED.toString();
	public static final String light_purple = ENUMLIGHT_PURPLE.toString();
	public static final String yellow = ENUMYELLOW.toString();
	public static final String white = ENUMWHITE.toString();
}
