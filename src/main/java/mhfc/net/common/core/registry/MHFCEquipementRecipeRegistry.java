...
public class MHFCEquipementRecipeRegistry {
	...
	static {
		...
		recipe_gs_bone = new EquipmentRecipe(new ItemStack(
			MHFCItemRegistry.weapon_gs_bone), listReq, 100, 500);
		...
		addItemStackToList(listReq, MHFCItemRegistry.mhfcitemkirin, 4,
			ItemKirin.KirinSubType.LIGHTCRYSTAL.ordinal());
		addItemStackToList(listReq, MHFCItemRegistry.mhfcitemkirin, 2,
		...
		//
		listReq = new ArrayList<ItemStack>();
		addItemStackToList(listReq, MHFCItemRegistry.mhfcitemtigrex, 6,
			ItemTigrex.TigrexSubType.SCALE.ordinal());
		addItemStackToList(listReq, MHFCItemRegistry.mhfcitemtigrex, 7,
			ItemTigrex.TigrexSubType.FANG.ordinal());
		addItemStackToList(listReq, MHFCItemRegistry.mhfcitemtigrex, 3,
			ItemTigrex.TigrexSubType.SHELL.ordinal());
		addItemStackToList(listReq, MHFCItemRegistry.mhfcitemtigrex, 4,
			ItemTigrex.TigrexSubType.SCALE.ordinal());
		addItemStackToList(listReq, MHFCItemRegistry.mhfcitemtigrex, 1,
			ItemTigrex.TigrexSubType.SKULLSHELL.ordinal());
		addItemStackToList(listReq, MHFCItemRegistry.mhfcitemingot, 2,
			ItemIngot.IngotsSubType.DRAGONITE.ordinal());
		recipe_gs_agito = new EquipmentRecipe(new ItemStack(
			MHFCItemRegistry.weapon_gs_tigrex), listReq, 500, 1000);
		MHFCEquipementRecipeRegistry.register(recipe_gs_agito);
		//
		listReq = new ArrayList<ItemStack>();

		addItemStackToList(listReq, MHFCItemRegistry.mhfcitemdeviljho, 7,
			ItemDeviljho.DeviljhoSubType.FANG.ordinal());
		addItemStackToList(listReq, MHFCItemRegistry.mhfcitemdeviljho, 7,
			ItemDeviljho.DeviljhoSubType.SCALE.ordinal());
		addItemStackToList(listReq, MHFCItemRegistry.mhfcitemdeviljho, 5,
			ItemDeviljho.DeviljhoSubType.TALON.ordinal());
		addItemStackToList(listReq, MHFCItemRegistry.mhfcitemdeviljho, 3,
			ItemDeviljho.DeviljhoSubType.SCALP.ordinal());
		addItemStackToList(listReq, MHFCItemRegistry.mhfcitemingot, 5,
			ItemIngot.IngotsSubType.DRAGONITE.ordinal());
		recipe_gs_berserker = new EquipmentRecipe(new ItemStack(
			MHFCItemRegistry.weapon_gs_berserkers), listReq, 600, 1500);
		MHFCEquipementRecipeRegistry.register(recipe_gs_berserker);
		//

		// Hammer Class
		listReq = new ArrayList<ItemStack>();
		addItemStackToList(listReq, Item.getItemById(265), 7, 0);// 265 is iron
																	// ingot
		addItemStackToList(listReq, Item
			.getItemFromBlock(MHFCBlockRegistry.mhfcblockdiskstone), 2, 0);
		...
		recipe_hm_warplus = new EquipmentRecipe(new ItemStack(
			MHFCItemRegistry.weapon_hm_warhammerplus), listReq, 100, 250);
		MHFCEquipementRecipeRegistry.register(recipe_hm_warplus);
		//
		listReq = new ArrayList<ItemStack>();
		addItemStackToList(listReq, MHFCItemRegistry.weapon_hm_warhammerplus,
			1, 0);
		...
		recipe_hm_warslammer = new EquipmentRecipe(new ItemStack(
			MHFCItemRegistry.weapon_hm_warslammer), listReq, 150, 300);
		MHFCEquipementRecipeRegistry.register(recipe_hm_warslammer);
		//
		listReq = new ArrayList<ItemStack>();
		addItemStackToList(listReq, MHFCItemRegistry.mhfcitemrathalos, 8,
		...
		recipe_hm_rathalos = new EquipmentRecipe(new ItemStack(
			MHFCItemRegistry.weapon_hm_rathalos), listReq, 300, 500);
		MHFCEquipementRecipeRegistry.register(recipe_hm_rathalos);
		//
		listReq = new ArrayList<ItemStack>();
		addItemStackToList(listReq, MHFCItemRegistry.mhfcitemtigrex, 3,
			ItemTigrex.TigrexSubType.CLAW.ordinal());
		addItemStackToList(listReq, MHFCItemRegistry.mhfcitemtigrex, 5,
			ItemTigrex.TigrexSubType.SCALE.ordinal());
		addItemStackToList(listReq, MHFCItemRegistry.mhfcitemtigrex, 5,
			ItemTigrex.TigrexSubType.SHELL.ordinal());
		addItemStackToList(listReq, MHFCItemRegistry.MHFCItemWyvernCoin, 10, 0);
		recipe_hm_tigrex = new EquipmentRecipe(new ItemStack(
			MHFCItemRegistry.weapon_hm_tigrex), listReq, 400, 700);
		MHFCEquipementRecipeRegistry.register(recipe_hm_tigrex);
		//
		listReq = new ArrayList<ItemStack>();
		addItemStackToList(listReq, MHFCItemRegistry.mhfcitemkirin, 10,
			ItemKirin.KirinSubType.MANE.ordinal());
		addItemStackToList(listReq, MHFCItemRegistry.mhfcitemkirin, 6,
			ItemKirin.KirinSubType.PLATINUMMANE.ordinal());
		addItemStackToList(listReq, MHFCItemRegistry.mhfcitemkirin, 5,
			ItemKirin.KirinSubType.LIGHTCRYSTAL.ordinal());
		addItemStackToList(listReq, MHFCItemRegistry.mhfcitemkirin, 3,
			ItemKirin.KirinSubType.PURECRYSTAL.ordinal());
		addItemStackToList(listReq, MHFCItemRegistry.mhfcitemkirin, 1,
			ItemKirin.KirinSubType.THUNDERTAIL.ordinal());
		addItemStackToList(listReq, MHFCItemRegistry.mhfcitemingot, 4,
			ItemIngot.IngotsSubType.ELTALITE.ordinal());
		recipe_hm_kirin = new EquipmentRecipe(new ItemStack(
			MHFCItemRegistry.weapon_hm_kirinspark), listReq, 750, 1200);
		MHFCEquipementRecipeRegistry.register(recipe_hm_kirin);
		//
		listReq = new ArrayList<ItemStack>();
		addItemStackToList(listReq, MHFCItemRegistry.mhfcitemdeviljho, 10,
			ItemDeviljho.DeviljhoSubType.FANG.ordinal());
		addItemStackToList(listReq, MHFCItemRegistry.mhfcitemdeviljho, 4,
			ItemDeviljho.DeviljhoSubType.SCALE.ordinal());
		addItemStackToList(listReq, MHFCItemRegistry.mhfcitemdeviljho, 6,
			ItemDeviljho.DeviljhoSubType.SCALP.ordinal());
		addItemStackToList(listReq, MHFCItemRegistry.mhfcitemingot, 4,
			ItemIngot.IngotsSubType.DRAGONITE.ordinal());
		recipe_hm_devilsdue = new EquipmentRecipe(new ItemStack(
			MHFCItemRegistry.weapon_hm_devilsdue), listReq, 750, 1800);
		...
		recipe_ls_ironkatana = new EquipmentRecipe(new ItemStack(
			MHFCItemRegistry.weapon_ls_ironkatana), listReq, 150, 600);
		MHFCEquipementRecipeRegistry.register(recipe_ls_ironkatana);
		//
		listReq = new ArrayList<ItemStack>();
		addItemStackToList(listReq, MHFCItemRegistry.mhfcitemremobra, 6,
			ItemRemobra.RemobraSubType.SKIN.ordinal());
		addItemStackToList(listReq, MHFCItemRegistry.mhfcitemremobra, 6,
			ItemRemobra.RemobraSubType.STRIPE.ordinal());
		addItemStackToList(listReq, MHFCItemRegistry.mhfcitemremobra, 2,
			ItemRemobra.RemobraSubType.WING.ordinal());
		recipe_ls_darkvipern = new EquipmentRecipe(new ItemStack(
			MHFCItemRegistry.weapon_ls_darkvipern), listReq, 500, 750);
		MHFCEquipementRecipeRegistry.register(recipe_ls_darkvipern);
		//
		// Hunting Horn Class
		listReq = new ArrayList<ItemStack>();
		recipe_hh_ivoryhorn = new EquipmentRecipe(new ItemStack(
			MHFCItemRegistry.weapon_hh_ivoryhorn), listReq, 100, 250);
		addItemStackToList(listReq, MHFCItemRegistry.mhfcitemingot, 3,
			ItemIngot.IngotsSubType.MACHALTIE.ordinal());
		...
		listReq = new ArrayList<ItemStack>();
		recipe_hh_metalbagpipe = new EquipmentRecipe(new ItemStack(
			MHFCItemRegistry.weapon_hh_metalbagpipe), listReq, 200, 400);
		addItemStackToList(listReq, MHFCItemRegistry.mhfcitemingot, 3,
			ItemIngot.IngotsSubType.MACHALTIE.ordinal());
		addItemStackToList(listReq, MHFCItemRegistry.mhfcitemmoldediron, 2, 0);
		...
		listReq = new ArrayList<ItemStack>();
		recipe_hh_tigrex = new EquipmentRecipe(new ItemStack(
			MHFCItemRegistry.weapon_hh_tigrex), listReq, 350, 600);
		addItemStackToList(listReq, MHFCItemRegistry.mhfcitemtigrex, 5,
			ItemTigrex.TigrexSubType.SHELL.ordinal());
		addItemStackToList(listReq, MHFCItemRegistry.mhfcitemtigrex, 7,
			ItemTigrex.TigrexSubType.FANG.ordinal());
		addItemStackToList(listReq, MHFCItemRegistry.mhfcitemingot, 10,
			ItemIngot.IngotsSubType.DRAGONITE.ordinal());
