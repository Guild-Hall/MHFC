...
import mhfc.net.common.item.armor.wip.KirinArmor;
import mhfc.net.common.item.armor.wip.RathalosArmor;
...
public class MHFCItemRegistry {
	...
	private static final IServiceKey<MHFCItemRegistry> serviceAccess = RegistryWrapper
			.registerService("item registry", MHFCItemRegistry::new,
					MHFCMain.preInitPhase);

	/**
	 * NOTE DISABLED ITEM VARIABLE HERE MEANS THEY ARE NOT FULLY FEATURED YET.
	 * ~@Heltrato
	 * 
	 * Please Arrange The Weapons by its RARITY refer to the weapon package
	 * ~@Heltrato
	 */
	// Weapons
	...
	public final Collection<Item> allItems = Collections
			.unmodifiableList(everyItems);
	...
	private MHFCItemRegistry() {
		...
		// Armor
		armor_yukumo_helm = registerItem("arm_yukumo_helmet",
				new YukumoArmor(EntityEquipmentSlot.HEAD));
		// armor_velociprey_helm = registerItem("arm_veloci_helmet", new
		// VelocipreyArmor(EntityEquipmentSlot.HEAD));
		// armor_jaggi_helm = registerItem("arm_great_jaggi_helmet", new
		// GreatJaggiArmor(EntityEquipmentSlot.HEAD));
		armor_rathalos_helm = registerItem("arm_rathalos_helmet",
				new RathalosArmor(EntityEquipmentSlot.HEAD));
		// armor_nibelsnarf_helm = registerItem("arm_nibelsnarf_helmet", new
		// NibelsnarfArmor(EntityEquipmentSlot.HEAD));
		armor_barroth_helm = registerItem("arm_barroth_helmet",
				new BarrothArmor(EntityEquipmentSlot.HEAD));
		armor_tigrex_helm = registerItem("arm_tigrex_helmet",
				new TigrexArmor(EntityEquipmentSlot.HEAD));
		armor_kirin_helm = registerItem("arm_kirin_helmet",
				new KirinArmor(EntityEquipmentSlot.HEAD));
		armor_vangis_helm = registerItem("arm_deviljho_helmet",
				new VangisArmor(EntityEquipmentSlot.HEAD));
		// armor_tigrexB_helm = registerItem("arm_tigrex_plus_helmet", new
		// KishinArmor(EntityEquipmentSlot.HEAD));
		// armor_dragoon_helm = registerItem("arm_dragoon_helmet", new
		// DragoonArmor(EntityEquipmentSlot.HEAD));
		// armor_kirinS_helm = registerItem("arm_kirin_s_helmet", new
		// KirinSArmor(EntityEquipmentSlot.HEAD));
		// armor_bionic_helm = registerItem("arm_bionic_helmet", new
		// ST_BionicArmor(EntityEquipmentSlot.HEAD));

		armor_yukumo_chest = registerItem("arm_yukumo_chestplate",
				new YukumoArmor(EntityEquipmentSlot.CHEST));
		// armor_velociprey_chest = registerItem("arm_veloci_chestplate", new
		// VelocipreyArmor(EntityEquipmentSlot.CHEST));
		// armor_jaggi_chest = registerItem("arm_great_jaggi_chestplate", new
		// GreatJaggiArmor(EntityEquipmentSlot.CHEST));
		armor_rathalos_chest = registerItem("arm_rathalos_chestplate",
				new RathalosArmor(EntityEquipmentSlot.CHEST));
		// armor_nibelsnarf_chest = registerItem("arm_nibelsnarf_chestplate",new
		// NibelsnarfArmor(EntityEquipmentSlot.CHEST));
		armor_barroth_chest = registerItem("arm_barroth_chestplate",
				new BarrothArmor(EntityEquipmentSlot.CHEST));
		armor_tigrex_chest = registerItem("arm_tigrex_chestplate",
				new TigrexArmor(EntityEquipmentSlot.CHEST));
		armor_kirin_chest = registerItem("arm_kirin_chestplate",
				new KirinArmor(EntityEquipmentSlot.CHEST));
		armor_vangis_chest = registerItem("arm_deviljho_chestplate",
				new VangisArmor(EntityEquipmentSlot.CHEST));
		// armor_tigrexB_chest = registerItem("arm_tigrex_plus_chestplate", new
		// KishinArmor(EntityEquipmentSlot.CHEST));
		// armor_dragoon_chest = registerItem("arm_dragoon_chestplate", new
		// DragoonArmor(EntityEquipmentSlot.CHEST));
		// armor_kirinS_chest = registerItem("arm_kirin_s_chestplate", new
		// KirinSArmor(EntityEquipmentSlot.CHEST));
		// armor_bionic_chest = registerItem("arm_bionic_chestplate", new
		// ST_BionicArmor(EntityEquipmentSlot.CHEST));

		armor_yukumo_legs = registerItem("arm_yukumo_leggings",
				new YukumoArmor(EntityEquipmentSlot.LEGS));
		// armor_velociprey_legs = registerItem("arm_veloci_leggings", new
		// VelocipreyArmor(EntityEquipmentSlot.LEGS));
		// armor_jaggi_legs = registerItem("arm_great_jaggi_leggings", new
		// GreatJaggiArmor(EntityEquipmentSlot.LEGS));
		armor_rathalos_legs = registerItem("arm_rathalos_leggings",
				new RathalosArmor(EntityEquipmentSlot.LEGS));
		// armor_nibelsnarf_legs = registerItem("arm_nibelsnarf_leggings", new
		// NibelsnarfArmor(EntityEquipmentSlot.LEGS));
		armor_barroth_legs = registerItem("arm_barroth_leggings",
				new BarrothArmor(EntityEquipmentSlot.LEGS));
		armor_tigrex_legs = registerItem("arm_tigrex_leggings",
				new TigrexArmor(EntityEquipmentSlot.LEGS));
		armor_kirin_legs = registerItem("arm_kirin_leggings",
				new KirinArmor(EntityEquipmentSlot.LEGS));
		armor_vangis_legs = registerItem("arm_deviljho_leggings",
				new VangisArmor(EntityEquipmentSlot.LEGS));
		// armor_tigrexB_legs = registerItem("arm_tigrex_plus_leggings", new
		// KishinArmor(EntityEquipmentSlot.LEGS));
		// armor_dragoon_legs = registerItem("arm_dragoon_leggings", new
		// DragoonArmor(EntityEquipmentSlot.LEGS));
		// armor_kirinS_legs = registerItem("arm_kirin_s_leggings", new
		// KirinSArmor(EntityEquipmentSlot.LEGS));
		// armor_bionic_legs = registerItem("arm_bionic_leggings", new
		// ST_BionicArmor(EntityEquipmentSlot.LEGS));

		armor_yukumo_boots = registerItem("arm_yukumo_boots",
				new YukumoArmor(EntityEquipmentSlot.FEET));
		// armor_velociprey_boots = registerItem("arm_veloci_boots", new
		// VelocipreyArmor(EntityEquipmentSlot.FEET));
		// armor_jaggi_boots = registerItem("arm_great_jaggi_boots", new
		// GreatJaggiArmor(EntityEquipmentSlot.FEET));
		armor_rathalos_boots = registerItem("arm_rathalos_boots",
				new RathalosArmor(EntityEquipmentSlot.FEET));
		// armor_nibelsnarf_boots = registerItem("arm_nibelsnarf_boots", new
		// NibelsnarfArmor(EntityEquipmentSlot.FEET));
		armor_barroth_boots = registerItem("arm_barroth_boots",
				new BarrothArmor(EntityEquipmentSlot.FEET));
		armor_tigrex_boots = registerItem("arm_tigrex_boots",
				new TigrexArmor(EntityEquipmentSlot.FEET));
		armor_kirin_boots = registerItem("arm_kirin_boots",
				new KirinArmor(EntityEquipmentSlot.FEET));
		armor_vangis_boots = registerItem("arm_deviljho_boots",
				new VangisArmor(EntityEquipmentSlot.FEET));
		// armor_tigrexB_boots = registerItem("arm_tigrex_plus_boots", new
		// KishinArmor(EntityEquipmentSlot.FEET));
		// armor_dragoon_boots = registerItem("arm_dragoon_boots", new
		// DragoonArmor(EntityEquipmentSlot.FEET));
		// armor_kirinS_boots = registerItem("arm_kirin_s_boots", new
		// KirinSArmor(EntityEquipmentSlot.FEET));
		// armor_bionic_boots = registerItem("arm_bionic_boots", new
		// ST_BionicArmor(EntityEquipmentSlot.FEET));

		// Weapons
		WeaponData jsonWeaponData = readLocalWeaponData();
		// FIXME: value tuning
		weapon_gs_bone = registerItem("gs_bone", jsonWeaponData);
		// weapon_gs_deadlyserpentblade = registerItem("gs_deadly_serpent",
		// jsonWeaponData);
		...
		weapon_ls_ironkatanagrace = registerItem("ls_iron_grace",
				jsonWeaponData);
		weapon_ls_ironkatanagospel = registerItem("ls_iron_gospel",
				jsonWeaponData);
		// weapon_ls_darkvipern = registerItem("ls_darkviper", jsonWeaponData);
		weapon_ls_eagercleaver = registerItem("ls_eagercleaver",
				jsonWeaponData);
		...
		// weapon_ls_miragefinswordplus = registerItem("ls_mirage_plus",
		// jsonWeaponData);
		// weapon_ls_liondancesaber = registerItem("ls_lion_dance",
		// jsonWeaponData);
		weapon_ls_truedevilslicer = registerItem("ls_devilslider_true",
				jsonWeaponData);
		// weapon_ls_phantommirage = registerItem("ls_mirage_phantom",
		// jsonWeaponData);
		// weapon_ls_lionkingsaber = registerItem("ls_lion_king",
		// jsonWeaponData);
		// weapon_ls_lionkaisersaber = registerItem("ls_lion_kaiser",
		// jsonWeaponData);
		// weapon_ls_lionsroarsaber = registerItem("ls_lion_roar",
		// jsonWeaponData);
		...
		weapon_hh_greatbagpipe = registerItem("hh_bagpipe_great",
				jsonWeaponData);
		weapon_hh_wardrums = registerItem("hh_wardrums", jsonWeaponData);
		weapon_hh_wardrumsplus = registerItem("hh_wardrums_plus",
				jsonWeaponData);
		weapon_hh_heavybagpipe = registerItem("hh_bagpipe_heavy",
				jsonWeaponData);
		weapon_hh_heavybagpipeplus = registerItem("hh_bagpipe_heavy_plus",
				jsonWeaponData);
		weapon_hh_tigrex = registerItem("hh_tigrex", jsonWeaponData);
		weapon_hh_mogwarddrums = registerItem("hh_wardrums_bongo",
				jsonWeaponData);
		weapon_hh_elitebagpipe = registerItem("hh_bigpipe_elite",
				jsonWeaponData);
		weapon_hh_darkthorntrumpet = registerItem("hh_darkthorn",
				jsonWeaponData);
		...
		weapon_b_huntersstoutII = registerItem("b_hunter_stout1",
				jsonWeaponData);
	...
	private WeaponData readLocalWeaponData() {
		try (InputStream weaponDataStream = MHFCItemRegistry.class
				.getResourceAsStream("weapons.json");
	...
	private <T extends Item> T registerItem(String registryName,
			WeaponData jsonWeaponData) {
		return registerItem(registryName,
				jsonWeaponData.configureItem(registryName));
	}
	 ...
	 *
	 * @param registryName
	 *            the registry name of the item. It should <b>never</b> change,
	 *            not even across versions.
	 * @param item
	 * @return
	 */
	...
	private <T extends Item> T registerItem(String registryName, T item) {
		...
		MHFCMain.logger().debug(
				"Registered " + item + " with id " + item.getRegistryName());
		everyItems.add(item);
		return item;
	}
